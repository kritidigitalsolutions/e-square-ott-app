            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Expanded(
                    child: Obx(() {
                      final status = controller.privacyStatus.value;
                      final doc = controller.privacyPolicyResponse.value?.data;
                      ...
                      return RefreshIndicator(
                        ...
                        onRefresh: controller.getPrivacyPolicy,
  ...
  Widget _buildFallbackContent() {
    return Column(
      ...
      children: const [
        ...
        _BulletItem('Basic device and usage information'),
        SizedBox(height: 8),
        ...
        _BulletItem('Manage your account and subscription'),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          ElevatedButton(
            onPressed: controller.getPrivacyPolicy,
...
class _MetadataSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final hasEmail =
        metadata.contactEmail != null && metadata.contactEmail!.isNotEmpty;
    final hasSupport =
        metadata.supportEmail != null && metadata.supportEmail!.isNotEmpty;
    final hasOfficer =
        metadata.dpoOfficer != null && metadata.dpoOfficer!.isNotEmpty;
    final hasJurisdiction =
        metadata.legalJurisdiction != null &&
